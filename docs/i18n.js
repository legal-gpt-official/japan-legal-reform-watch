...
(function () {
  ...
  var STRINGS = {
    en: {
      ...
      alert_pilot_body:
        "We are preparing personalized alerts based on saved searches, including public-comment deadline reminders.",
    ...
    "zh-Hans": {
      ...
      alert_pilot_body: "我们正在准备基于保存搜索的个性化提醒，包括公开征求意见截止日期提醒。",
