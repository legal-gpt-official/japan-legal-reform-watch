...
- Monitor repository and Pages artifact growth as the uncapped canonical corpus and uncapped yearly shards expand; split storage further only if a concrete platform limit or material performance issue appears.
